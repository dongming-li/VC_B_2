...
/**
 * Servlet used to get the movable nodes if a Carriage token is activated by jack
 * @author sauerbreiale
 *
 */
public class Carriage extends HttpServlet {
	
	//Holds the map for logic to be done on the nodes of the map
	BoardMap map = new BoardMap(BoardMap.serverpath + "board.xml");
	
	/**
	 * Method used to show the nodes a Jack player is able to move to when a carriage is activated
	 * 
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		Set<String> moveableNodes= jack.getMovableNodes(false, true).keySet();
